...
# unseen mail count based on loaded JSON data
...
def get_dashboard_data():
    ...
    pending_responses = get_unseen_mail_count()  
    completed_responses = unseen_mails - pending_responses
    error_log = ["Error fetching email #3", "Timeout in response generation"]  
...
def fetch_unseen_emails():
    update_email_data()  # fetch the unseen emails and update the JSON
...
#  route to run main.py can be any .py file you like 
