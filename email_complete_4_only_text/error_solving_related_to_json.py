...
def create_tasks(email_body, classifier, responder):
    ...
    classify_email = Task(
        ...
        # output_format="to_dict"  # Set the output format to JSON
    )
...
def process_emails(file_path):
    ...
    for email_content in email_contents:
        ...
        classify_email_output = classify_email.output.raw
        respond_to_email_output = respond_to_email.output.raw
        ...
        email_result = {
            ...
            "Responder Output": respond_to_email_output
        }

        all_results.append(email_result)

    # Save all results to a JSON file
    output_filepath = '/data/aiuserinj/sarjil/mail_summarizer/email_complete_4_only_text/task_output2.json'
